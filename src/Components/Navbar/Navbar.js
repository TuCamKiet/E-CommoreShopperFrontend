...
const Navbar = () => {
  ...
  return (
    <div className="navbar sticky top-0 bg-[#fde1ff] flex justify-between p-[max(2px,1vh)] shadow-[0_1px_3px_-2px_black] min-w-fit select-none">
      <div className="nav-logo flex items-center gap-x-px cursor-pointer">
        <img
          ...
          alt="logo"
        />
        <span className="text-[#171717] text-[clamp(16px,4.3vw,38px)] overflow-hidden w-0 md:w-fit font-semibold">
          SHOPPER
        </span>
      </div>

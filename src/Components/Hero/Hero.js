...
const Hero = () => {
  ...
  return (
    <div className="hero bg-[linear-gradient(180deg,#fde1ff,#e1ffea22_60%)] flex w-full">
      <div className="hero-left flex flex-col flex-1 justify-center gap-[clamp(0.415rem,4.15vmin,1.25rem)] leading-none sm:pl-[5vw]">
        ...
        <div className="hero-latest-btn flex justify-center items-center gap-[clamp(0.291rem,2.91vmin,0.875rem)] w-[clamp(6rem,60vmin,18rem)] h-[clamp(1.4rem,14.3vmin,4rem)] text-[clamp(0.5rem,5vmin,1.5rem)] mt-[clamp(0.58rem,5.8vmin,1.75rem)] rounded-full bg-[#ff4141] text-white font-medium cursor-pointer">
